...
function rejectDrawingTrendingLine() {
    drawingTrendingLine = null
    isDrawingFreeTrendingLine = false
    isDrawingHzTrendingLine = false
}

function startFreeTrendingLineDrawing() {
    drawingTrendingLine = null
    isDrawingFreeTrendingLine = true;
}

function startHzTrendingLineDrawing() {
    drawingTrendingLine = null
...
export {
    initCharts, addZoom, addDataPoint,
    drawLineChart, drawCandleStickChart,
    rejectDrawingTrendingLine, startFreeTrendingLineDrawing, startHzTrendingLineDrawing,
    drawAxis, updateAxis,
    drawGrid, updateGrid,
    drawSMALine, hideSMALine,
    createTooltip, handleToolipMouseMove, handleToolipMouseLeave,
    startTrendingLinePriceHighlight, coverTrendingLinePriceHighlight, endTrendingLinePriceHighlight, handleTrendingLineOnScaleUpdate, addTrendingLines, removeDrawingLine
}
